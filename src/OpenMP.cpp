...
std::pair<size_t, size_t> OpenMP::Solve(Graph *graph)
{
...
void OpenMP::DFS(VerticeCollection vertices, EdgeCollection left, EdgeCollection used)
{
...
#pragma omp task shared(vertices, left, used)
{
